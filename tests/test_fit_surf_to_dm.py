...
from coralign.util.fit_surf_to_dm import resample_inf_func, build_prefilter, fit_surf_to_dm
from coralign.util.pad_crop import pad_crop
from coralign.util.dmshapes import zernike
...
class TestFitSurfToDm(unittest.TestCase):
    ...
    def test_success(self):
        ...
        fit_surf_to_dm(self.surf, self.act_effect)
        pass
    ...
    def test_same_size_input_output(self):
        ...
        for shape in shapelist:
            ...
            act_effect = build_prefilter(shape[0],
                                         ...
                                         self.inf_func,
                                         self.ppa_in)
            out = fit_surf_to_dm(surf, act_effect)
    ...
    def test_invalid_surf(self):
        ...
        for perr in [np.ones((48,)), np.ones((48, 48, 2)),
                     'txt', [1, 2], 0, 1j, -3.5]:
            with self.assertRaises(TypeError):
                fit_surf_to_dm(perr, self.act_effect)
                pass
            pass
        pass
    ...
    def test_convolution_recovery(self):
        ...
        # Zernike DM shape
        dm0 = zernike(48, 46.3, 1.0, 10) # some trefoil
        ppa_in = 1.
        ...
        for inf_func in [np.exp(-R2)/np.pi, # normalize to unity under integral
            ...
            dm1 = fit_surf_to_dm(surf, act_ef)
